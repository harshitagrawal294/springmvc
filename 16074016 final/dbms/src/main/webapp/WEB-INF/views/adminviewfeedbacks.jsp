...
<body>
<a href="/dbms/admin/allorders" style="font-size:15px;margin-left:40px">Back</a>
<h2 style="text-align:center">Feedbacks</h2>


<%-- 	<form:form method="post" modelAttribute="feedback" action="/dbms/admin/viewfeedbacks/${orderid}">
		<table>
		<tr><td>
		Feedback</td><td>
	...
	<form:form action ="/dbms/admin/viewfeedbacks/${orderid}" modelAttribute="feedback" method="post" class="search-container">
	...
	<%-- <c:forEach items="${feedbacks}" var="feedback">
	    <tr>
	    	<td>${feedback.feedback}</td><br>
	    	<td>${feedback.feedbackdate}</td><br>
	    	<td>${feedback.feedbacktime}</td>
	     </tr>
	     <br><br>
	</c:forEach>
	<a href="/dbms/admin/allorders">Back</a> --%>
