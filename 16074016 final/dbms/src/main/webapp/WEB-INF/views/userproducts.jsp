 ...
 -->						<th style="width:50%">Product</th>
					...
					<tfoot>
						...
						<tr>
							...
							<td><a href="/dbms/placeorder" class="btn btn-success btn-block" style="background-color:black; border: black;margin-top:10px">Checkout<i class="fa fa-angle-right"></i></a></td>
