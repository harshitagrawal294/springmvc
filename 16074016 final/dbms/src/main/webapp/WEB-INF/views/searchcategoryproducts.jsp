...
<%-- <body>
	<h2 style="text-align:center">Search Results for ${category.categoryname}</h2>
	
	<form action = "/dbms/categories/searchproducts/${categoryid}" method="post">
