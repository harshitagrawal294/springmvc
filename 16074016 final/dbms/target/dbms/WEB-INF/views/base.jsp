...
<body>
    <nav class="navbar navbar-inverse bg-inverse navbar-fixed-top">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
            	<c:if test="${pageContext.request.userPrincipal.name != null}">
                	...
                	<li><a href="/dbms/categories">Categories</a></li>
                	<li><a href="/dbms/orderhistory">Orders</a></li>
                	<li><a href="/dbms/favorites">Favorites</a></li>
                	<li><a href="/dbms/top">Top</a></li>
            	</c:if>
            	<c:if test="${pageContext.request.userPrincipal.name == null}">
      ...
      <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="/dbms/notifications">Notifications</a></li>
